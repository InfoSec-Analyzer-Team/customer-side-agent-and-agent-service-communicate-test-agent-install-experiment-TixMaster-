...
- 樣本數：192（⚠️ provisional，< MIN_SAMPLES，數字僅供參考）
- **Diversity_stage = 0.2424**

## Warnings

- ⚠️ stage 1: n_samples=192 < MIN_SAMPLES=200，熵/QCD 數字僅供參考（provisional），CI 不得當硬門檻
...
| --- | --- | --- | --- |
| `os_type` | 0.3258 | 0.25 | 0, 2, 3, 4, 5, 6 |
| `ua_length` | 0.8347 | — | — |
